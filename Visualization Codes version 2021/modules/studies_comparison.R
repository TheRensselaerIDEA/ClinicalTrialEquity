...
preprocess_comparison_df<-function(sig_t, cut1,cut2, selected_metrics, disease_type, file_list){
  ...
  if (disease_type == "diabetes"){
    ...
    df_comparison_studies_new$Group_Name<-c("Female","Male","18-44","45-64","64+","Non-Hispanic White","Non-Hispanic Black","Hispanic","Other","Less than high school","High-school graduate","Some college/Technical school","College degree or higher","Current smoker" ,"Not smoke","Underweight","Normal weight","Overweight","Obese","less than 120","120-129","130-139","greater than 139","Normal","High","less than 100","100-125","greater than 125")
  }
  else if (disease_type == "hypertension"){
