    ...
    if (showBackgroundUploader()) {
      ...
      column(12,
            ...
            tags$div(
                    ...
                    h3("Discussion"),
                    p("The normalized metrics provide an intuitive standardized scale for evaluating representation across subgroups, which may have vastly different enrollment fractions and rates in RCT study cohorts. The metrics are beneficial complements to other approaches (e.g., enrollment fractions) used to identify generalizability and health equity of RCTs."), 
                    h3("Conclusion"),
